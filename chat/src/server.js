//	nodemon app.js     https://horgeninc.slack.com/messages/CGTSY4CF3
//  npm config set proxy=http://127.0.0.1:8580   npm config list
var SlackBot = require('../chat/node_modules/slackbots');
var express = require('../chat/node_modules/express');
var app = express();
var path = require('path');
var server = require('http').createServer(app);
var io = require('../chat/node_modules/socket.io')(server);
...
io.on('connection', (socket) => {
  ...
  socket.on('disconnect', (uid) => {
    console.log(socket.id+' : quit.  '+uid);
    for (let u in talks){
